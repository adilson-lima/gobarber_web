...
const Dashboard: React.FC = () => {
    ...
    const [monthAvalilability, setMonthAvailability ] = useState<MonthAvalilabilityItem[]>([])
    ...
    const disabledDays = useMemo(()=>{
        const dates = monthAvalilability.filter(monthDay => monthDay.available === false)
        .map(monthDay => {
    ...
    }, [currentMonth, monthAvalilability])
